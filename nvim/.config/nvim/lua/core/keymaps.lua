...
-- telescope
keymap.set("n", "<leader>ff", "<cmd>Telescope find_files find_command=rg,--no-ignore,--hidden,--files<cr>") -- find files within current working directory, respects .gitignore
